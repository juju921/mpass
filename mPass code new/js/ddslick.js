    ...
    var methods = {
        ...
        if ($('#css-ddslick').length <= 0) {
                var ddslickCSS = '<style id="css-ddslick" type="text/css">' +
                                        '.dd-select{ border-radius:2px; border:solid 1px #000000; position:relative; cursor:pointer;}' +
                                        '.dd-desc { color:#000000; display:block; overflow: hidden; font-weight:normal;  }' +
                                        ...
                                        '.dd-option-image, .dd-selected-image { vertical-align:middle; float:left; margin-right:5px; max-width:64px; padding: 5px 0  0 5px;}' +
